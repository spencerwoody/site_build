...
style="max-width:35%;min-width:75px;float:center;" alt="Github repo"
...
the University of Texas at Austin, advised by [James Scott][james],
within the [Department of Statistics and Data Sciences][sds]. My main
research interests are in post-selection inference as applied to
multiple testing, model selection, and spatial hotspot detection
scenarios. I also work as a research assistant for [Carlos
Carvahlo][carlos], with whom I am working on problems in causal
